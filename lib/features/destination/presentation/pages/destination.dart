                      ...
                      ElevatedButton(
                        style: ButtonStyle(
                          ...
                          fixedSize: MaterialStateProperty.all(
                              Size(MediaQuery.of(context).size.width - 30, 48)),
                          backgroundColor: MaterialStateProperty.all(
                            Color(0xffFFBB23),
                          ),
                        ),
                        onPressed: () async {
                          if (widget.fromMetro.placeId == state.metro.placeId) {
                            showDialog(
                              context: context,
                              builder: (BuildContext context) {
                                return ErrorPopup(
                                  title: "Error!",
                                  message:
                                      "Your destination can't be the same as your current station. Please select a different station.",
                                  action: "To Search",
                                  actionFunc: () {
